...
#file_sets["SP_fielder"]="SSP1_enhancers.bed SSP2_enhancers.bed SSP3_enhancers.bed"
#file_sets["RO_fielder"]="SRO1_enhancers.bed SRO2_enhancers.bed SRO3_enhancers.bed"
#file_sets["LE_fielder"]="SLE1_enhancers.bed SLE2_enhancers.bed SLE3_enhancers.bed"
#file_sets["IS_fielder"]="SIS1_enhancers.bed SIS2_enhancers.bed SIS3_enhancers.bed"
#file_sets["R_cadenza"]="CR1_enhancers.bed CR2_enhancers.bed CR3_enhancers.bed CR4_enhancers.bed CR5_enhancers.bed"
#file_sets["L_cadenza"]="CL1_enhancers.bed CL2_enhancers.bed CL3_enhancers.bed CL4_enhancers.bed CL5_enhancers.bed"

file_sets['fielder_cadenza_all']="shared_RO_fielder_at_least_2_overlaps_max_score_enhancers.bed shared_LE_fielder_at_least_2_overlaps_max_score_enhancers.bed shared_IS_fielder_at_least_2_overlaps_max_score_enhancers.bed shared_SP_fielder_at_least_2_overlaps_max_score_enhancers.bed shared_R_cadenza_at_least_2_overlaps_max_score_enhancers.bed shared_L_cadenza_at_least_2_overlaps_max_score_enhancers.bed"
...
for category in "${!file_sets[@]}"; do
    ...
    output_file="${input_dir}/shared_${category}_at_least_${number_shared_files}_overlaps_enhancers.bed"
    max_score_file="${input_dir}/shared_${category}_at_least_${number_shared_files}_overlaps_max_score_enhancers.bed"
